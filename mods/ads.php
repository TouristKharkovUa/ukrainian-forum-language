...
$lang = array_merge($lang, array(
	...
	'ABOVE_HEADER_LEFT'		=> 'Над шапкой слева',
	'ABOVE_HEADER_RIGHT'	=> 'Над шапкой справа',
	...
	'AFTER_QUICK_REPLY'		=> 'После быстрого ответа',
	'BELOW_FOOTER'			=> 'Под нижним колонтитулом',									//'Below Footer',
	'BELOW_HEADER'			=> 'Под верхним колонтитулом',									//'Below Header',
	'BELOW_HEADER_LEFT1'	=> 'Под шапкой слева 1ряд',
	'BELOW_HEADER_RIGHT1'	=> 'Под шапкой справа 1ряд',
	'BELOW_HEADER_LEFT2'	=> 'Под шапкой слева 2ряд',
	'BELOW_HEADER_RIGHT2'	=> 'Под шапкой справа 2ряд',
	'BELOW_HEADER_LEFT3'	=> 'Под шапкой слева 3ряд',
	'BELOW_HEADER_RIGHT3'	=> 'Под шапкой справа 3ряд',
	...
	'AD_GROUPS_EXPLAIN'							=> 'Укажите группы для которых <strong>НЕ ПОКАЗЫВАТЬ</strong> рекламу. Удерживайте CTRL для выбора нескольких групп.',	//'Select the groups you do <strong>NOT</strong> want this advertisement to be shown to.  You may select multiple groups by holding the CTRL key while clicking more groups.',	
