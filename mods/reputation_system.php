...
$lang = array_merge($lang, array(
	'RS_REPUTATION'		=> 'Репутация продавца',
	...
	'RS_POST_COUNT'				=> 'Баллы за сообщения',
	'RS_USER_COUNT'				=> 'Баллы от пользователей',
	...
	'RS_RATE_POST'				=> 'Оценить продавца',
	'RS_RATE_USER'				=> 'Оценить продавца',
	'RS_RANK'					=> 'Ранг',
	...
	'RS_TO_USER'				=> 'Кому',
	'RS_TYPE'					=> 'Тип',
	'RS_USER_RATING'			=> 'Оценка продавца',
	...
	'RS_TOPLIST'				=> 'Лучшая репутация продавца',
	...
	'RS_NEW_REP'				=> 'У вас <b>1 новый</b> комментарий к оценке',
	'RS_NEW_REPS'				=> 'У вас <b>%s новых</b> комментариев к оценке',
	'RS_CLICK_TO_VIEW'			=> 'Просмотреть полученные оценки',

	'RS_MORE_DETAILS'			=> '» подробнее',

	'RS_HIDE_POST'	 			=> 'Это сообщение, написанное <b>%1$s</b>, скрыто, так как у сообщения низкая репутация. %2$s',
	...
	'RS_USER_REPUTATION'		=> 'Репутация %s',
	...
	'RS_POWER_DETAILS'			=> 'Как рассчитывается сила репутации',
